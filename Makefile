...
pkgdatadir = $(datadir)/perceus
pkgincludedir = $(includedir)/perceus
pkglibdir = $(libdir)/perceus
pkglibexecdir = $(libexecdir)/perceus
...
DIST_COMMON = README $(am__configure_deps) $(srcdir)/Makefile.am \
	$(srcdir)/Makefile.in $(srcdir)/perceus.spec.in \
	$(top_srcdir)/3rd_party/Makefile.in $(top_srcdir)/configure \
	$(top_srcdir)/docs/perceus-nsa-quickstart.tex.in \
	$(top_srcdir)/docs/perceus-userguide.tex.in \
	$(top_srcdir)/post/Makefile.in AUTHORS COPYING ChangeLog \
...
CONFIG_CLEAN_FILES = perceus.spec post/Makefile 3rd_party/Makefile \
	docs/perceus-userguide.tex docs/perceus-nsa-quickstart.tex
...
ACLOCAL = ${SHELL} /usr/src/perceus/1.6.2/missing --run aclocal-1.11
AMTAR = ${SHELL} /usr/src/perceus/1.6.2/missing --run tar
AR = ar
AUTOCONF = ${SHELL} /usr/src/perceus/1.6.2/missing --run autoconf
AUTOHEADER = ${SHELL} /usr/src/perceus/1.6.2/missing --run autoheader
AUTOMAKE = ${SHELL} /usr/src/perceus/1.6.2/missing --run automake-1.11
AWK = gawk
BINDIR = 
...
LIBDNS = /lib/../lib/libnss_dns.so.2
LIBEXECDIR = 
LIBOBJS = 
LIBPTHREAD = /lib/../lib/libpthread.so.0
LIBRESOLV = /lib/../lib/libresolv.so.2
LIBRT = /lib/../lib/librt.so.1
LIBS = 
LIBTOOL = $(SHELL) $(top_builddir)/libtool
LIBUUID = /lib/../lib/libuuid.so.1
LIB_LD = /lib/../lib/ld-linux-x86-64.so.2
LINK_LIBZ = /usr/lib/gcc/x86_64-linux-gnu/4.4.5/../../../../lib/libz.a
LIPO = 
LN_S = ln -s
LOCALSTATEDIR = 
LTLIBOBJS = 
MAKEINFO = ${SHELL} /usr/src/perceus/1.6.2/missing --run makeinfo
MKDIR_P = /bin/mkdir -p
NASM = /usr/bin/nasm
NM = /usr/bin/nm -B
NMEDIT = 
...
OTOOL64 = 
PACKAGE = perceus
PACKAGE_BUGREPORT = gmk@infiscale.com
PACKAGE_NAME = perceus
PACKAGE_STRING = perceus 1.6.0
PACKAGE_TARNAME = perceus
PACKAGE_URL = 
...
STRIP = strip
VERSION = 1.6.0
abs_builddir = /usr/src/perceus/1.6.2
abs_srcdir = /usr/src/perceus/1.6.2
abs_top_builddir = /usr/src/perceus/1.6.2
abs_top_srcdir = /usr/src/perceus/1.6.2
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
am__leading_dot = .
...
initfs_arch = x86_64
install_sh = ${SHELL} /usr/src/perceus/1.6.2/install-sh
...
$(am__aclocal_m4_deps):
perceus.spec: $(top_builddir)/config.status $(srcdir)/perceus.spec.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
post/Makefile: $(top_builddir)/config.status $(top_srcdir)/post/Makefile.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
3rd_party/Makefile: $(top_builddir)/config.status $(top_srcdir)/3rd_party/Makefile.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
docs/perceus-userguide.tex: $(top_builddir)/config.status $(top_srcdir)/docs/perceus-userguide.tex.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
docs/perceus-nsa-quickstart.tex: $(top_builddir)/config.status $(top_srcdir)/docs/perceus-nsa-quickstart.tex.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
